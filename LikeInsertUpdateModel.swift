...
class LikeInsertUpdateModel: NSObject{
    ...
    func InsertItems(uSeqno: String, ctSeqno: String, prdSeqno: String) -> Bool { // 매개변수 값으로 데이터 들어오고 리턴값 Bool로 받음
    ...
    func UpdateItems(uSeqno: String, ctSeqno: String) -> Bool { // 매개변수 값으로 데이터 들어오고 리턴값 Bool로 받음
        var result: Bool = true // 리턴값 설정
