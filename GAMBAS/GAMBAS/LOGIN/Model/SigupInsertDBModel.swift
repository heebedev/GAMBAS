...
class SigupInsertDBModel:NSObject{
    ...
    func uploadImageFile(at filepath: URL,Email: String, Password:String, Name:String, Birth:String, Phone:String,  interestCategory:String, completionHandler: @escaping(Data?, URLResponse?) -> Void) {
            // 경로를 준비하고
            let url = URL(string:"http://127.0.0.1:8080/test/Userinfo_Insert_ios.jsp")!
            let parameters = [
                "email" : Email,
                "Password" : Password,
                "Name" : Name,
