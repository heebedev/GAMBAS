...
class ContentsViewController: UIViewController, ContentsViewQueryModelProtocol, UITableViewDataSource, UITableViewDelegate, CommentListQueryModelProtocol {
    ...
    func contentsViewItemDownloaded(items: NSArray) {
        ...
        print("좋아요했니?",itemContentsView.checkmylikecontents!)
...
//        let itemCommentList: SubscribeDBModel = commentListFeedItem[0] as! SubscribeDBModel
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let endIdx: String.Index = formatRegistDate.index(formatRegistDate.startIndex, offsetBy: 10)
